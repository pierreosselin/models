...
from bandits.algorithms.neural_greedy import NeuralGreedy
...
flags.DEFINE_string(
    'moon_data',
    os.path.join(base_route, data_route, 'moondata.csv'),
    'Directory where Moon data is stored.')
flags.DEFINE_string(
    'xor_data',
    os.path.join(base_route, data_route, 'xordataset.csv'),
    'Directory where Xor data is stored.')
flags.DEFINE_string(
    'statlog_data',
